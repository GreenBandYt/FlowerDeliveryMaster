...
SECRET_KEY = 'django-insecure-r+&+4!o3^-=8tb0fs523v6&_bqi9(nzms^uu6i*t&!z=59f+ry'
...
ALLOWED_HOSTS = []
# DEBUG = False
# ALLOWED_HOSTS = ['127.0.0.1', 'localhost']  # Убедитесь, что ваш хост включен
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Указан путь к папке static
]
